...
TYPE, PUBLIC :: ControlParameters
    ...
    INTEGER(IntKi)                :: PTC_ControlMode             ! Turn Power Trackin Control on {0: off, 1: on}
    INTEGER(IntKi)                :: PTC_DR_Mode                 ! Down-regulation mode (1 if torque tracking, 2 if min[torque tracking, torque greedy])
